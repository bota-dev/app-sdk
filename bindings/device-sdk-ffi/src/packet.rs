...
pub mod kind {
    ...
    pub const COMMAND_STREAM_RECORDING: u32 = 0x010b;
    pub const COMMAND_TRANSFER_ENCRYPTED_RECORDING: u32 = 0x010c;
    ...
    pub const HOST_EVENT_STREAMING_SINK_ACCEPTED: u32 = 0x0228;
    pub const HOST_EVENT_STREAMING_SINK_FINALIZED: u32 = 0x0229;
    pub const HOST_EVENT_STREAMING_SINK_FAILED: u32 = 0x022a;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_CHECKPOINT_LOADED: u32 = 0x022b;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_SINK_TRUNCATED: u32 = 0x022c;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_SESSION_PREPARED: u32 = 0x022d;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_TRANSFER_STARTED: u32 = 0x022e;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_RESUME_REJECTED: u32 = 0x022f;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_WINDOW_STAGED: u32 = 0x0230;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_CHECKPOINT_SAVED: u32 = 0x0231;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_WINDOW_ACKNOWLEDGED: u32 = 0x0232;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_TRANSFER_COMPLETED: u32 = 0x0233;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_ARTIFACTS_STAGED: u32 = 0x0234;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_RECEIPT_ACCEPTED: u32 = 0x0235;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_RECORDING_CONFIRMED: u32 = 0x0236;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_MIXED_PROFILE: u32 = 0x0237;
    pub const HOST_EVENT_ENCRYPTED_UPLOAD_V2_FAILED: u32 = 0x0238;
    ...
    pub const HOST_EFFECT_STREAMING_SINK_APPEND_PLAINTEXT: u32 = 0x033c;
    pub const HOST_EFFECT_STREAMING_SINK_BEGIN_ENCRYPTED: u32 = 0x033d;
    pub const HOST_EFFECT_STREAMING_SINK_APPEND_ENCRYPTED: u32 = 0x033e;
    pub const HOST_EFFECT_STREAMING_SINK_FINALIZE: u32 = 0x033f;
    pub const HOST_EFFECT_FIRMWARE_BLOB_READ: u32 = 0x0340;
    pub const HOST_EFFECT_STREAMING_SINK_DISCARD: u32 = 0x0341;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_LOAD_CHECKPOINT: u32 = 0x0342;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_DELETE_CHECKPOINT: u32 = 0x0343;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_TRUNCATE_SINK: u32 = 0x0344;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_PREPARE_SESSION: u32 = 0x0345;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_START_TRANSFER: u32 = 0x0346;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_REPAIR_WINDOW: u32 = 0x0347;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_SAVE_CHECKPOINT: u32 = 0x0348;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_ACKNOWLEDGE_WINDOW: u32 = 0x0349;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_STAGE_ARTIFACTS: u32 = 0x034a;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_AWAIT_RECEIPT: u32 = 0x034b;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_CONFIRM_WITH_RECEIPT: u32 = 0x034c;
    pub const HOST_EFFECT_ENCRYPTED_UPLOAD_V2_ABORT: u32 = 0x034d;
    ...
    pub const NOTIFICATION_STREAMING_PAUSED: u32 = 0x040d;
    pub const NOTIFICATION_STREAMING_RESUMED: u32 = 0x040e;
    pub const NOTIFICATION_STREAMING_COMPLETED: u32 = 0x040f;
    pub const NOTIFICATION_ENCRYPTED_UPLOAD_V2_STAGED: u32 = 0x0410;
    ...
    pub const PROTOCOL_DECODE_ENCRYPTED_UPLOAD_V2_CATALOG: u32 = 0x0527;
    pub const PROTOCOL_ENCODE_UPLOAD_CONTEXT_BEGIN: u32 = 0x0528;
    pub const PROTOCOL_DECODE_UPLOAD_CONTEXT_SNAPSHOT: u32 = 0x0529;
    pub const PROTOCOL_DECODE_UPLOAD_CONTEXT_DOCUMENT: u32 = 0x052a;
    pub const PROTOCOL_DECODE_ENCRYPTED_UPLOAD_V2_AUTHORIZATION_IDENTITY: u32 = 0x052b;
    pub const PROTOCOL_VALIDATE_ENCRYPTED_UPLOAD_V2_ADMISSION: u32 = 0x052c;
}
...
pub mod field_id {
    ...
    pub const OWNER_REVISION: u32 = 165;
    pub const UPLOAD_PROFILE: u32 = 166;
    pub const UPLOAD_SECURITY_POLICY: u32 = 167;
    ...
    pub const CONTEXT_ATTEMPT_ID: u32 = 199;
    pub const CONTEXT_STATE: u32 = 200;
    pub const AUTHORIZATION_CHANNELS: u32 = 201;
    pub const MIN_CIPHERTEXT_LENGTH: u32 = 202;
    pub const MAX_CIPHERTEXT_LENGTH: u32 = 203;
    pub const REQUIRE_EXPIRED_SESSION_RECOVERY: u32 = 204;
}

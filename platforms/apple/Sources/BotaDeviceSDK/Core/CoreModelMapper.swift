...
final class CoreModelMapper: @unchecked Sendable {
    ...
    fileprivate static func invalid(_ detail: String) -> BotaDeviceSDKError {
        BotaDeviceSDKError(code: .invalidInput, operation: .decode, retryable: false, detail: detail)
    }
}
...
extension BotaDeviceSDKError {
    ...
    static func code(_ raw: UInt32) -> BotaDeviceSDKErrorCode {
        switch raw {

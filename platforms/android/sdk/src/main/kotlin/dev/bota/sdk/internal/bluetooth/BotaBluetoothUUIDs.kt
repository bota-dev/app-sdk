...
internal object BotaBluetoothUUIDs {
    ...
    val RecordingControl: UUID = botaUuid(0x0002, 0x0002)
    val RecordingStatus: UUID = botaUuid(0x0002, 0x0003)
    val TimeSync: UUID = botaUuid(0x0002, 0x0004)
    val DeviceCommand: UUID = botaUuid(0x0002, 0x0005)
    val ProvisioningService: UUID = botaUuid(0x0003, 0x0000)
    val PairingState: UUID = botaUuid(0x0003, 0x0001)
    val ApiEndpoint: UUID = botaUuid(0x0003, 0x0003)
    val DeviceSettings: UUID = botaUuid(0x0003, 0x0006)
    val StorageService: UUID = botaUuid(0x0004, 0x0000)
    val TransferCapabilitiesV2: UUID = botaUuid(0x0004, 0x0006)
    val TransferSignedBlobV2: UUID = botaUuid(0x0004, 0x0007)
    val TransferControlV2: UUID = botaUuid(0x0004, 0x0008)
    ...
    val BackendPublicKey: UUID = botaUuid(0x0005, 0x0003)
    val DeviceCertificate: UUID = botaUuid(0x0005, 0x0004)

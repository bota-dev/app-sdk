...
bytes. It is not an installable replacement yet: Apple and Android adapters,
the complete 0.0.65 compatibility surface, app acceptance, and npm publication
remain open.
...
contract is generated by React Native 0.86.3 for both iOS and Android.

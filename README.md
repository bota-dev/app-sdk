...
[publication record](release/evidence/2.0.0-beta.0-publication.md). Web and Flutter
automated-publisher configuration remain follow-ups, separate from the verified
packages now available to install.

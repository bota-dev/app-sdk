...
/** A retained device fault. Reading does not acknowledge or delete it. */
export interface DeviceDiagnosticEvent {
  ...
  report?: {
    ...
    execution: { task?: string; reti?: string; rets?: string; pc_trace: string[] };
    runtime?: { heap_free_bytes?: number; task_stack_remaining_bytes?: number };
    breadcrumbs?: Array<{ delta_ms: number; code: string; arg0: number }>;
  };
}

...
progress. Every effect request carries a stable operation and cancellation ID.
...
Milestone 1 defines this vocabulary and its invariants only. Reconnect,
provisioning, transfer, upload, OTA, device-log, and reset reducers are deferred
to Milestone 2.

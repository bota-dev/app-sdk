...
- Produces additive ABI packet kinds `0x0520..0x0522` for capability,
  ...
  appended `0x0523` for canonical signed-blob encoding and `0x0524` for the
  app-originated v2 transfer controls. Existing
...
0x0524 ENCODE_ENCRYPTED_UPLOAD_V2_TRANSFER (later additive runtime extension)
```

...
The `1.2.0-beta.4` candidate has no selected browser/device session. Every row
...
export WEB_TARBALL="$APP_SDK_ROOT/target/web-release/bota.dev-web-sdk-1.2.0-beta.4.tgz"
...
`1.2.0-beta.4` publication exception above does not turn a `NOT RUN` row into
